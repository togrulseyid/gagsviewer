...
import com.togrulseyid.gags.adapters.CustomImageAdapter;
...
public class GagsImageFragment extends Fragment {
    ...
    public static GagsImageFragment newInstance() {
    ...
    private void saveData(int id) {
        sharedPref.edit().putInt(getString(R.string.image_id), id).commit();
    }
