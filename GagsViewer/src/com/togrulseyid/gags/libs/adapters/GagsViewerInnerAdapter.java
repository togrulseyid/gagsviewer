...
public class GagsViewerInnerAdapter extends FragmentPagerAdapter implements
	...
	public Fragment getItem(int position) {
		...
		case 0:
			...
			frg = GagsImageFragment.newInstance(CONTENT[position
					% CONTENT.length]);
			break;

		case 1:
			moPubView.setVisibility(View.VISIBLE);
			frg = GagsAnimationFragment.newInstance(CONTENT[position
					% CONTENT.length]);
			break;

		case 2:
			moPubView.setVisibility(View.VISIBLE);
			frg = GagsVideoFragment.newInstance(CONTENT[position
					% CONTENT.length]);
			break;

		case 3:
			moPubView.setVisibility(View.VISIBLE);
			frg = GagsJokesFragment.newInstance(CONTENT[position
					% CONTENT.length]);
			break;
